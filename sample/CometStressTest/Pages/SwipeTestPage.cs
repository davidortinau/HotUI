...
public class SwipeTestPage : View
{
	...
	View body()
	{
		...
		{
			Text = $"📧 Swipe Test — {remainingCount.Value} items remaining",
			FontSize = 18,
	...
	{
		emails.Remove(email);
		remainingCount.Value = emails.Count;
